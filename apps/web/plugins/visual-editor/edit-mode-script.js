...
import { getElementType, isInFixedContext, isolateEditorUiEvents } from "./utils/dom-utils.js";
...
/* ------------------------------------------------------------------ *
 * Focus isolation — prevents host-page focus traps (Radix FocusScope,
 * etc.) from yanking focus out of the editor's floating UI.
 * ------------------------------------------------------------------ */
...
function enableEditMode() {
	...
	document.addEventListener("focusin", handleEditorFocusGuard, true);
	document.addEventListener("focusout", handleEditorFocusGuard, true);
...
function disableEditMode() {
	...
	document.removeEventListener("focusin", handleEditorFocusGuard, true);
	document.removeEventListener("focusout", handleEditorFocusGuard, true);
	endDragSelect();
