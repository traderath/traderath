...
const SignupPage = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            setError('We could not create your account. That email may already be registered.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="flex min-h-screen bg-slate-50">
            <Helmet>
                <title>Create account — TradeRath</title>
                <meta name="description" content="Create your TradeRath account and start managing export orders, documents, compliance, shipments and payments." />
            </Helmet>
            ...
            <div className="flex w-full flex-col items-center justify-center px-5 py-10">
                <div className="w-full max-w-sm">
                    ...
                    <div className="rounded-xl border border-slate-200 bg-white p-7 shadow-[0_1px_3px_rgba(15,23,42,0.06)]">
                        ...
                        <p className="mt-1 text-sm text-slate-500">Start managing your export operations in one place.</p>
